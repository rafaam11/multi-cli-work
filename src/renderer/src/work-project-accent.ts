 ...
 * only four values are suggested (see WORK_PROJECT_CATEGORIES) — so the mapping to a colour has to
 ...
 */
export type WorkProjectAccent = "government" | "outsourcing" | "product" | "etc";
...
/** Anything outside the four suggested categories reads as 기타 — grey, not a missing colour. */
